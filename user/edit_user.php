<?php
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST"){
        ...
        if (isset($_POST["nome"]) && isset($_POST["email"]) && isset($_POST["perfil"]) && isset($_POST["carro"])){
            ...
            $sql = "UPDATE usuario SET nome = '" . $nome . "', email = '" . $email . "', carro = '" . $carro . "', imagem = '" . $perfil . "' WHERE id = '" . $_SESSION["id_usuario"] . "'";
